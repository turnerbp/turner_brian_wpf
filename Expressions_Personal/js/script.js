...
var monthWeeks = prompt("How many weeks in the month you are calculating?");
...
console.log ("I have dance practice " + dancePractice+ " times and dance " + dancePracticeHrsPerWeek + " hours per week." + " I run " + runWeek + " times and "+ runMinsPerWeek + " minutes per week." + " I dance " + dancePerMonth + " times and " + danceHrsPerMonth + " hours per month." + " I run " + runDaysPerMonth + " days and" + " run " + runMinsPerMonth + " minutes per month.");
