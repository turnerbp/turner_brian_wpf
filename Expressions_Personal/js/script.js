...
console.log ("I have dance practice " + dancePractice+ " times per week and dance " + danceHours + " hours per week." + " I run " + runWeek + "times per week and "+ runTime + monthWeeks + dancePracticeHrsPerWeek + runMinsPerWeek + dancePerMonth + danceHrsPerMonth + runDaysPerMonth + runMinsPerMonth);
